...
<head>
    ...
    function list_onclick(ftrCde, ftrIdn, longitude, latitude, accidentTime)
    {
    	var form = document.listForm;
   		...
   		form.action = "<c:url value='/drainpipe/selectDrainAccidentDetail.do?pipeFtrCde="   + ftrCde
   																		 + "&pipeFtrIdn="   + ftrIdn
   																		 + "&longitude="    + longitude
   																		 + "&latitude="     + latitude
	    	...
	    	<table width="100%" border="0">
	    		<tr>
	    			<td>
	                    ...
	                    <font size="4"><b>&nbsp;하수도 사고정보 목록</b></font>
	                </td>
	    		</tr>
