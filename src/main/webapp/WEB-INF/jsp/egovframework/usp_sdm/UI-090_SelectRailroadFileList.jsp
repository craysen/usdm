...
<head>
    ...
    /* 목록 선택 이벤트 */
    function list_onclick(file_id)
    {
    	var form = document.listForm;
    	
   		form.action = "<c:url value='/railroad/selectRailroadVideoDetail.do?fileId=" + file_id + "'/>";
    	form.submit();
    }
	    	...
	    	<table width="100%" border="0">
	    		<tr>
	    			<td>
	                    ...
	                    <font size="4"><b>&nbsp;도시철도 센싱 데이터 파일 조회</b></font>
	                </td>
	    		</tr>
        	...
        	<div id="search">
        		...
        		<table width="100%" border="0" cellpadding="0" cellspacing="0">
        			...
        			<tr>
        				...
        				<td colspan="3">
        					<form:input path="poi" id="poi" style="width:300px" onfocus="this.select()"/>
        				</td>
        			</tr>
        			<tr><td bgcolor="#FFFFFF" height="3px" colspan="5"></td></tr>
        			<tr><td bgcolor="#97A6B0" height="3px" colspan="5"></td></tr>
        	...
        	<div id="table">
        		<table width="100%" border="0" cellpadding="0" cellspacing="0">
        			...
        			<tr>
        				...
        				<th align="center">계측기/시험</th>
        				<th align="center">촬영시작</th>
        				<th align="center">촬영종료</th>
        			</tr>
        			<c:forEach var="result" items="${resultList}" varStatus="status">
            			<tr onclick="javascript:list_onclick('${result.videoid}')" style="cursor:pointer;" onmouseover=this.style.backgroundColor="#F5F5F5" onmouseout=this.style.backgroundColor="#FFFFFF">
            				<td align="center" class="listtd"><c:out value="${result.videotypename}"/></td>
            				<td align="left" class="listtd"><c:out value="${result.filename}"/></td>
            				<td align="center" class="listtd"><c:out value="${result.measuretypename}"/></td>
            				<td align="center" class="listtd"><c:out value="${result.recstarttime}"/></td>
            				<td align="center" class="listtd"><c:out value="${result.recendtime}"/></td>
            			</tr>
        			</c:forEach>
        		</table>
        	</div>
